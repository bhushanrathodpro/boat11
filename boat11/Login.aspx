<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="boat11.WebForm3" %>
    ...
    <form id="form2" runat="server" style="background-color:black">
                ...
                <div class="container-fluid" style="color: red">
                    ...
                    <div class="navbar-collapse collapse" >
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li id="B" class="active" runat="server"><a href="Login.aspx">Login</a> </li>
                            </ul>
                    </div>
        ...
        <header>
            <div class="wrapper">
                ...
                <div style= "background-color:red; align-content:center; margin-left:25%; margin-right:25%; height: 632px; margin-top:5%; width: 793px;">

                    <br />
                   
                    <div style="text-align:center; width: 382px; height: 549px; margin-left: 213px; margin-top: 33px; background-color:aliceblue">
                        &nbsp;<br />
                        <asp:Label ID="Label1" runat="server" Text="Enter Your Details Below To Login" ForeColor="Black" Font-Bold="True" Font-Names="Arial Narrow" Font-Size="Medium"></asp:Label>

                        <br />
                        <br />
                        <br />
                        <asp:Label ID="Label2" runat="server" Font-Names="Berlin Sans FB" Font-Size="Large" Font-Strikeout="False" Text="Enter Your Username Here"></asp:Label>
                        <br />
                        <br />
                        ...
                        <br />
                        <asp:Label ID="Label3" runat="server" Font-Names="Berlin Sans FB" Font-Size="Large" Font-Strikeout="False" Text="Enter Your Password Here"></asp:Label>
                        <br />
                        <br />
                        ...
                        <br />
                        <br />
                        <asp:CheckBox ID="rmme" runat="server" ClientIDMode="AutoID" ForeColor="Black" Text="Remember Me" />

                        <br />

                        <br />
                        <div style="width: 191px; margin-left: 97px" >
                            <asp:Button ID="btn1" runat="server" class="btn btn-success" Text="Log in" Width="90px" OnClick="btn1_Click" />
                            <br />
                            <br />
                            ...
                            <asp:HyperLink ID="forgot" runat="server" NavigateUrl="~/forgot.aspx">forgot your password! click here</asp:HyperLink>
                        &nbsp;<br />
                            <br />
                            <asp:HyperLink ID="signin" runat="server" NavigateUrl="~/signin.aspx">Don't have an Account? Register Here</asp:HyperLink>
                        </div>
                        <br />
                    </div>
                    </div>
